...
class SocialAuthLoginSerializer(serializers.Serializer):  # noqa
    ...
    def validate(self, attrs):
        ...
        # Case 2: We received the authorization code
            ...
            self.callback_url = getattr(view, "callback_url", None)  # noqa
            self.client_class = getattr(view, "client_class", None)  # noqa
